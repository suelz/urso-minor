...
<body>
	...
	<h3 class="test">Movies directed by <%=request.getParameter("director") %></h3>
	<br>
	<br>
	<%	
		String selectedDirector = request.getParameter("director");
		try {
			...
			String query = "select * from movie where director='" + selectedDirector + "'";
