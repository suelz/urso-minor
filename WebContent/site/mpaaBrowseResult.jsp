...
<body>
	...
	<h3 class="test">Movies rated <%=request.getParameter("mpaaRating")%></h3>
	<br>
	<br>
	<%	
		String selectedMPAARating = request.getParameter("mpaaRating");
		try {
			...
			String query = "select * from movie where movieMPAARating='" + selectedMPAARating + "'";
