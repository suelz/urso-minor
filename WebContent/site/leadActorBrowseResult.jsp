...
<body>
	...
	<h3 class="test">Movies with <%=request.getParameter("leadActor") %> as a lead actor/actress</h3>
	<br>
	<br>
	<%	
		String selectedLeadActor = request.getParameter("leadActor");
		try {
			...
			String query = "select * from movie where actor1='" + selectedLeadActor + "'";
