...
<body>
	...
	<h3 class="test">Movies sorted by <%=request.getParameter("sortOption") %></h3>
	<br>
	<br>
	<%	
		String selectedSortOption = request.getParameter("sortOption");
		try {
			...
			String query = "select * from movie order by " + selectedSortOption;
